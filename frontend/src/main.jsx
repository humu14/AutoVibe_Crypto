...
const router = createBrowserRouter(
  createRoutesFromElements(
    <Route path="/" element={<App />}>
      ...
      <Route path='/posts/public' element={<PublicPostsScreen />} />
      ...
      <Route path='' element={<PrivateRoute />}> <Route path='/myposts' element={<MyPostsScreen />} /> </Route>
      ...
      <Route path='' element={<AdminRoute />}> <Route path='/admin/keys' element={<KeyManagementScreen />} /> </Route>
